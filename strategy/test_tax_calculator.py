from strategy.tax import (
    calculates_income_tax,
    calculate_xpto_tax,
    IncomeTax,
    XptoTax,
)
from strategy.tax_calculator import TaxCalculator
...
def test_oop_approach_should_calculate_income_tax_with_correctly_percentage():
    tax_calculator = TaxCalculator()
    income_tax = tax_calculator.calculate_tax(budget=500, tax=IncomeTax().calculate)
    assert income_tax == 50.0


def test_oop_approach_should_calculate_xpto_tax_with_correctly_percentage():
    tax_calculator = TaxCalculator()
