...
from chain_of_responsibility.discount import DiscountForMoreThanFiveHundredSpent, NoDiscount
from chain_of_responsibility.chain_of_discount_calculator import ChainOfDiscountCalculator
...
def test_should_use_discount_for_more_than_five_items(mock_no_discount, mock_discount_for_more_than_five_hundred):
    budget = Budget()
